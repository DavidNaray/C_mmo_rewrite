...
export class Tile{
    ...
    async addToScene(Obj_Identifier,MetaData){
        ...
        this.instancePooling.GeneralAddInstance(Obj_Identifier,transform,MetaData);
    }

    UpdateBuilding(building,Sid,Health){

    }

    AdjustBuildingOpacity(Sid,Opacity){
        this.instancePooling.setInstanceOpacity(Sid,Opacity)
    }    
